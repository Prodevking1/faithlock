...
export default function LandingPage() {
  return (
    <div className="bg-slate-950 text-slate-400 font-sans antialiased overflow-x-hidden pb-32 md:pb-0">
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-slate-950/80 backdrop-blur-xl transition-all duration-500">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
            <a href="#how-it-works" className="hover:text-white transition-colors" data-track-nav="How it Works">How it Works</a>
      ...
      <section id="how-it-works" className="py-20 bg-slate-950 relative" data-track-section="how_it_works">
      ...
      {/* ── FAQ ── */}
      <section id="faq" className="py-16 bg-slate-950" data-track-section="faq">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <details
                key={i}
                className="group bg-slate-900/50 rounded-xl border border-white/5 overflow-hidden"
