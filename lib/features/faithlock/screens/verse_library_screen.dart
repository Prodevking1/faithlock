...
class _VerseLibraryScreenState extends State<VerseLibraryScreen> {
  late final VerseLibraryController controller;
  late final ScrollController _scrollController;

  @override
  void initState() {
    super.initState();
    controller = Get.put(VerseLibraryController());
  ...
  void _onScroll() {
    // Check if user is near bottom (within 200 pixels)
                ...
                child: Obx(() {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (index == controller.filteredVerses.length) {
                        return Padding(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        color:
                                            _getCategoryColor(verse.category),
                                        fontSize: 12,
                                        fontWeight: FontWeight.w600,
                                      ),
                                    ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isSelected ? FastColors.primary : FastColors.border(context),
        ...
        child: Text(
          label,
          style: TextStyle(
            color: isSelected ? Colors.white : FastColors.primaryText(context),
            fontSize: 14,
