...
class SignUpScreen extends GetView<SignUpController> {
  ...
  Widget _buildForm() {
    return Column(
      children: [
        FastTextInput(
          controller: controller.formState.fullNameController,
        ...
        if (controller.enablePasswordConfirm) ...[
          FastSpacing.h16,
          FastPasswordInput(
            controller: controller.formState.confirmPasswordController,
  ...
  Widget _buildLoginLink() {
    return Row(
      ...
      children: [
        ...
        GestureDetector(
          onTap: () => NavigationHelper.navigateTo(AppRoutes.signIn),
          child: Container(
            padding: const EdgeInsets.symmetric(
